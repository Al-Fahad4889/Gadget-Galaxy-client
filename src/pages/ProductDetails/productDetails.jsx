                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                            ...
                            <div className="lg:flex lg:items-start">
                                <div className="lg:order-2 lg:ml-5">
                                    <div className="max-w-xl overflow-hidden rounded-lg">
                                        <img className="h-full w-full max-w-full object-cover" src={details.image} alt="" />
                                    </div>
                                </div>
                                ...
                                <div className="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                                    <div className="flex flex-row items-start lg:flex-col">
                                        <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                                            <img className="h-full w-full object-cover" src={details.image} alt="{details.image} " />
                                        </button>
                        ...
                        <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                            <h1 className="sm: text-2xl font-bold text-gray-900 sm:text-3xl">{details.model} </h1>
                            ...
                            <h2 className="mt-8 text-base text-gray-900 font-bold">Category</h2>
                            <div className="mt-3 flex select-none flex-wrap items-center gap-1">
                                <label className="">
                                    <input type="radio" name="type" value="Powder" className="peer sr-only" checked />
                                    <p className="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">{details.category}</p>
                                </label>
                                <label className="">
                            ...
                            <div className="mt-3 flex select-none flex-wrap items-center gap-1">
                                <label className="">
                                    <input type="radio" name="subscription" value="4 Months" className="peer sr-only" checked />
                                ...
                                <label className="">
                                    ...
                                    <p className="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">White</p>
                                    <span className="mt-1 block text-center text-xs"></span>
                                </label>
                            </div>
                            ...
                            <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                                <div className="flex items-end">
                                    ...
                                    <span className="text-base">/per piece</span>
                                </div>
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <div className="mt-8 flow-root sm:mt-12">
                                <h1 classNameName="text-3xl font-bold">Delivered To Your Door</h1>
