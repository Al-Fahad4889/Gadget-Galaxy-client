    ...
    return (
        ...
        <div>
            ...
            <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
                <a href="#" className="text-2xl font-serif font-bold text-gray-800">Order Section</a>
            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div className="px-4 pt-8">
                    ...
                    <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                        ...
                        <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                            <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://diamu.com.bd/wp-content/uploads/2022/09/Samsung-Galaxy-Watch-5-Silver-40mm.jpg" alt="" />
                            <div className="flex w-full flex-col px-4 py-4">
                                <span className="font-semibold">Samsung Smart Watch</span>
                                <span className="float-right text-gray-400">42EU - 8.5US</span>
